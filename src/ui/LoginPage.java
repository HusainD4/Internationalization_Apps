...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(892, 70));
        ...
        gridBagConstraints.insets = new java.awt.Insets(137, 235, 139, 281);
        jPanel2.add(jPanel3, gridBagConstraints);
        jPanel3.getAccessibleContext().setAccessibleName("");

        getContentPane().add(jPanel2, java.awt.BorderLayout.CENTER);

        setSize(new java.awt.Dimension(984, 606));
...
private void applyFont() {
    ...
    private void applyLanguage() {
        ...
        try {
            ...
            btnBack.setText(rb.getString("LoginPage.btnBack.text"));
